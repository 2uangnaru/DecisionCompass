...
import { VERSION, RULESET, WEIGHTS, LUCK_BASELINE, CATEGORIES, MODES, combine, decision, percent, percentTenths, scoreForMode, weightedTimeAverage, round, weightsFor, boundedCache, clamp, evidence } from './core.js';
